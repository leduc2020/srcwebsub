...
$checkKey = checkAddonLicense($CMSNT->site('gateway_xipay_license'), 'SMMPANEL2_GATEWAY_XIPAY');
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div
                                                ...
                                                <strong><?=__('Chú ý');?>:</strong> <?=__('Bạn cần phải mua giấy phép kích hoạt');?> <a
                                                    ...
                                                    href="https://client.cmsnt.co/cart.php?a=add&pid=84"><?=__('Addon');?></a> <?=__('trước khi sử dụng');?>.
                                            </div>
                                    </div>
                                </div>
                                <?php else:?>
