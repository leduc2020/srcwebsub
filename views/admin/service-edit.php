...
$body = [
    'title' => __('Chỉnh sửa gói dịch vụ'),
    'desc'   => 'CMSNT Panel',
...
if (isset($_GET['id'])) {
    ...
    if (!$row) {
        redirect(base_url_admin('services'));
    }
} else {
    redirect(base_url_admin('services'));
}
...
if (isset($_POST['SaveService'])) {
    ...
    if ($isUpdate) {
        $CMSNT->insert("logs", [
            ...
            'device'        => getUserAgent(),
            'createdate'    => gettime(),
            'action'        => __('Chỉnh sửa gói dịch vụ')." (".check_string($_POST['name']).")."
        ]);
        /** NOTE ACTION */
        $my_text = $CMSNT->site('noti_action');
        $my_text = str_replace('{domain}', $_SERVER['SERVER_NAME'], $my_text);
        $my_text = str_replace('{username}', $getUser['username'], $my_text);
        $my_text = str_replace('{action}', __('Chỉnh sửa gói dịch vụ')." (".check_string($_POST['name']).").", $my_text);
...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-1"><i
                    class="fa-solid fa-pen-to-square me-2"></i><?=__('Chỉnh sửa gói dịch vụ');?></h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a
                                href="<?=base_url_admin('services');?>"><?=__('Gói dịch vụ');?></a></li>
            ...
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="category_id" class="form-control js-example-basic-single" required>
                                        ...
                                        <option <?=$row['category_id'] == $sub_category['id'] ? 'selected' : '';?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="type" class="form-control js-example-basic-single" required id="service_type_select_edit">
                                        <?php foreach(getListServiceType() as $service_type):?>
                                        <option <?=$row['type'] == $service_type['code'] ? 'selected' : '';?> value="<?=$service_type['code'];?>" data-description="<?=$service_type['description'];?>">
                                            <?=$service_type['name'];?>
                                        </option>
                                        <?php endforeach?>
                                    </select>
                                    ...
                                    <div id="service_type_description_edit" class="mt-2" style="display: none;">
                                        <div class="alert alert-info-transparent border-info border-opacity-25">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <span id="description_text_edit" class="text-muted"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea name="description" id="description" rows="6" 
                                              class="form-control" 
                                              placeholder="<?=__('Nhập mô tả chi tiết về dịch vụ');?>"><?=$row['description'];?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="cost" type="number" step="any" min="0" value="<?=$row['cost'];?>"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="price" type="number" step="any" min="0" value="<?=$row['price'];?>"
                                               class="form-control" placeholder="0.0000" required>
                                        <span class="input-group-text"><?=currencyDefault();?></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="price_1" type="number" step="any" min="0" value="<?=$row['price_1'];?>"
                                               class="form-control" placeholder="0.0000" required>
                                        <span class="input-group-text"><?=currencyDefault();?></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="price_2" type="number" step="any" min="0" value="<?=$row['price_2'];?>"
                                               class="form-control" placeholder="0.0000" required>
                                        <span class="input-group-text"><?=currencyDefault();?></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="price_3" type="number" step="any" min="0" value="<?=$row['price_3'];?>"
                                               class="form-control" placeholder="0.0000" required>
                                        <span class="input-group-text"><?=currencyDefault();?></span>
                                    </div>
                                </div>
                    ...
                    <div class="card custom-card shadow-sm mt-4">
                        <div class="card-header bg-light d-flex justify-content-between align-items-center">
                            ...
                            <div class="form-check form-switch" id="quantity-setting-checkbox">
                                <input class="form-check-input" type="checkbox" value="1" <?=($row['auto_sync_min_max'] == 1) ? 'checked' : '';?>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="min" type="number" value="<?=$row['min'];?>"
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="max" type="number" value="<?=$row['max'];?>"
                ...
                <div class="col-xl-4">
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <select class="form-control form-select" name="display" required>
                                    <option <?=$row['display'] == 'show' ? 'selected' : '';?> value="show">
                                        <i class="fa fa-eye"></i> <?=__('Hiển thị');?>
                                    </option>
                                    <option <?=$row['display'] == 'hide' ? 'selected' : '';?> value="hide">
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <select name="supplier_id" class="form-control js-example-basic-single">
                                    ...
                                    <?php foreach($CMSNT->get_list("SELECT * FROM `suppliers` WHERE `status` = 1") as $supplier):?>
                                    <option <?=$row['supplier_id'] == $supplier['id'] ? 'selected' : '';?>
                                            value="<?=$supplier['id'];?>">
                                        <?=$supplier['domain'];?>
                                    </option>
                                    <?php endforeach?>
                            ...
                            <div class="mb-4" id="api-id-container">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="api_id" type="text" value="<?=$row['api_id'];?>"
                    ...
                    <div class="card custom-card shadow-sm mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" value="1"
                                               id="auto_get_average_time" name="auto_get_average_time" 
                                               <?=($row['auto_get_average_time'] == 1) ? 'checked' : '';?>>
                                ...
                                <div class="input-group">
                                    <input name="average_time" type="text" value="<?=$row['average_time'];?>" required
                    ...
                    <div class="card custom-card shadow-sm mt-4">
                        <div class="card-header bg-light">
                            <div class="card-title text-uppercase">
                                <i class="fa-solid fa-history me-2 text-info"></i>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label fw-semibold text-muted">
                                    <i class="fa-solid fa-plus-circle me-1"></i><?=__('Ngày tạo');?>
                                </label>
                                <div class="input-group">
                            ...
                            <div class="mb-0">
                                <label class="form-label fw-semibold text-muted">
                                    <i class="fa-solid fa-edit me-1"></i><?=__('Cập nhật cuối');?>
                                </label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light">
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Khởi tạo trạng thái ban đầu dựa trên supplier hiện tại
        ...
        // Lắng nghe sự kiện thay đổi nhà cung cấp để xử lý checkbox auto_sync_min_max
        $('select[name="supplier_id"]').on('change', function() {
            const supplierId = $(this).val();
            handleAutoSyncCheckboxVisibility(supplierId);
        });
        
        // Khởi tạo trạng thái ban đầu cho checkbox auto_sync_min_max
         ...
         */
        function showServiceTypeDescriptionEdit() {
            const selectedOption = $('#service_type_select_edit option:selected');
            const description = selectedOption.data('description');
            const descriptionContainer = $('#service_type_description_edit');
            const descriptionText = $('#description_text_edit');
        ...
        $('#service_type_select_edit').on('change', function() {
            showServiceTypeDescriptionEdit();
        });
        
        // Kiểm tra trạng thái ban đầu (hiển thị description cho type đã được chọn)
        if ($('#service_type_select_edit').val()) {
            showServiceTypeDescriptionEdit();
        }
