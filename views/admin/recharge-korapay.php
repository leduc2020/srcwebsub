...
$checkKey = checkAddonLicense($CMSNT->site('korapay_license'), 'SMMPANEL2_GATEWAY_KORAPAY');
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div
                                            ...
                                            <strong><?=__('Chú ý');?>:</strong> <?=__('Bạn cần phải mua giấy phép kích hoạt');?> <a
                                                ...
                                                href="https://client.cmsnt.co/cart.php?a=add&pid=85"><?=__('Addon');?></a> <?=__('trước khi sử dụng');?>.
                                        </div>
                                    </div>
                                </div>
                                <?php else:?>
