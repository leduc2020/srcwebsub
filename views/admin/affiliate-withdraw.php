...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0"><?=__('Affiliate Withdraw');?></h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="#"><?=__('Affiliate Program');?></a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?=__('Affiliate Withdraw');?></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-fill">
                                ...
                                <p class="mb-0 text-muted"><?=__('Tổng số tiền đã rút');?></p>
                            </div>
                            <div class="ms-2">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-fill">
                                ...
                                <p class="mb-0 text-muted"><?=__('Tiền rút trong tháng');?> <?=date('m');?></p>
                            </div>
                            <div class="ms-2">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-fill">
                                ...
                                <p class="mb-0 text-muted"><?=__('Tiền rút trong tuần');?></p>
                            </div>
                            <div class="ms-2">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-fill">
                                ...
                                <p class="mb-0 text-muted"><?=__('Tiền rút hôm nay');?></p>
                            </div>
                            <div class="ms-2">
