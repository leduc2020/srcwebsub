...
$urlDatatable = pagination_client(base_url("?action=recharge-korapay&limit=$limit&shortByDate=$shortByDate&time=$time&trans_id=$trans_id&amount=$amount&"), $from, $totalDatatable, $limit);
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div
                        ...
                        <h4 class="mb-sm-0"><?=__('Nạp tiền qua Korapay');?></h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="#"><?=__('Nạp tiền');?></a></li>
                                <li class="breadcrumb-item active"><?=__('Korapay');?></li>
                            </ol>
                        </div>
            ...
            <div class="row">
                        ...
                        <div class="card-header bg-primary bg-soft py-3">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?=base_url('assets/img/icon-korapay.webp');?>"
                                        alt="<?=__('Nạp tiền qua Korapay');?>" class="icon-card">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h4 class="card-title mb-0 text-white"><?=__('Nạp tiền qua Korapay');?></h4>
                        ...
                        <div class="card-body">
                            <div class="alert alert-secondary bg-soft-secondary border-0 mb-4" role="alert">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="alert-heading fs-14 mb-1"><?=__('Hướng dẫn nạp Korapay');?></h5>
                                        <p class="mb-0 fs-13"><?=__('Nhập số tiền cần nạp và nhấn nút giao dịch để bắt đầu quá trình nạp tiền.');?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form id="recharge-form" class="needs-validation" novalidate>
                                <div class="mb-4">
                                    <label for="amount" class="form-label fw-medium"><?=__('Số tiền nạp ('.$CMSNT->site('korapay_currency_code').')');?> <span class="text-danger">*</span></label>
                                    <div class="input-group input-group-lg has-validation">
                                        ...
                                        <span class="input-group-text bg-light text-primary fw-medium"><?=$CMSNT->site('korapay_currency_code');?></span>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0"><?=__('Lịch sử nạp tiền Korapay');?></h4>
                        </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-xxl-3 col-sm-6">
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="<?=base_url('?action=recharge-korapay');?>" class="btn btn-light waves-effect waves-light w-100">
                                    ...
                                    <table class="table align-middle table-nowrap">
                                        ...
                                        <tbody class="list form-check-all" id="invoice-list-data">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end fw-medium"><?=$row['amount'];?> <?=$CMSNT->site('korapay_currency_code');?></td>
                                    ...
                                    <div class="p-3 bg-soft-info rounded-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <span class="fw-bold text-danger fs-16"><?=format_currency($CMSNT->get_row(" SELECT SUM(`price`) FROM `payment_korapay` WHERE $where AND `status` = 1 ")['SUM(`price`)']);?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        try {
            ...
            if (amount > 0) {
                ...
                $.ajax({
                    ...
                    error: function() {
                        // Fallback khi có lỗi kết nối
                        var estimatedAmount = amount * 23000; // Giá trị mặc định
                        $(".conversion-box").addClass("border-primary").removeClass("border-dashed");
                        $("#vnd_amount").html(estimatedAmount.toLocaleString('vi-VN'));
                    }
                });
            } else {
