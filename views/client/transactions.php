            ...
            <div class="row">
                <div class="col-12">
                    <div
                        ...
                        <h4 class="mb-sm-0"><?=__('Biến động số dư');?></h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a
                                        href="<?=base_url('client/profile');?>"><?=__('Tài khoản');?></a></li>
                                <li class="breadcrumb-item active"><?=__('Biến động số dư');?></li>
                            </ol>
                        </div>
                    ...
                    <div class="card" id="invoiceList">
                        <div class="card-header border-0">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title mb-0 flex-grow-1"><?=__('Biến động số dư');?></h5>
                            </div>
                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-xxl-3 col-sm-6">
                                        <div class="search-box">
                                            <input type="text" class="form-control search bg-light border-light"
                                                name="reason" value="<?=$reason;?>" placeholder="<?=__('Lý do');?>">
                                        ...
                                        <div>
                                            <select name="type" class="form-select">
                                                <option value="" <?=$type == '' ? 'selected' : '';?>>
                                                    <?=__('Tất cả biến động');?></option>
                                                <option value="plus" <?=$type == 'plus' ? 'selected' : '';?>>
                                                    <?=__('Cộng tiền');?></option>
                                                <option value="minus" <?=$type == 'minus' ? 'selected' : '';?>>
                                                    <?=__('Trừ tiền');?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-sm-6">
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="<?=base_url('?action=transactions');?>"
                                        ...
                                        <tbody class="list form-check-all" id="invoice-list-data">
                                                ...
                                                <td colspan="5" class="text-center">
                                                    <div class="text-center p-3">
                                                        ...
                                                        <p class="text-muted mb-0">
                                                            <?=__('Không có biến động số dư nào được tìm thấy');?>
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td data-toggle="tooltip" data-placement="bottom"
                                                    title="<?=timeAgo(strtotime($row['thoigian']));?>">
                                                    <?=date('d/m/Y H:i:s', strtotime($row['thoigian']));?></td>
                                                <td class="text-center">
                                                    <span><?=format_currency($row['sotientruoc']);?></span>
                                                </td>
                                                <?php if(($row['sotiensau'] - $row['sotientruoc']) > 0):?>
                                                <td class="text-center"><b
                                                        class="text-success">+<?=format_currency($row['sotienthaydoi']);?></b>
                                                </td>
                                                <?php elseif(($row['sotientruoc'] - $row['sotiensau']) > 0):?>
                                                <td class="text-center"><b
                                                        class="text-danger">-<?=format_currency($row['sotienthaydoi']);?></b>
                                                </td>
                                                <?php else:?>
                                                <td class="text-center">
                                                    <b><?=format_currency($row['sotienthaydoi']);?></b>
                                                </td>
                                                <?php endif?>
                                                <td class="text-center"><b
                                                        class="text-secondary"><?=format_currency($row['sotiensau']);?></b>
                                                </td>
